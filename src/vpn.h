...
#define AUTH_TYPE_PLUGIN (1<<7)

#define ALL_AUTH_TYPES ((AUTH_TYPE_PAM|AUTH_TYPE_PLAIN|AUTH_TYPE_CERTIFICATE|AUTH_TYPE_RADIUS|AUTH_TYPE_GSSAPI|AUTH_TYPE_PLUGIN) & (~AUTH_TYPE_USERNAME_PASS))
